...
We use KC Home Sales Data to predict home prices in King County, USA. We
processed this data and explored Linear, WLS, robust, ridge, elastic net
lasso regressions, NN and logistic models and select models for use

## I. Introduction

The problem at hand is to provide estimates of home prices in King
County, USA. These predictions could potentially be helpful in home
appraisal and help determine the fair market value of a home.
...
We reviewed model diagnostics with application of appropriate
transformations as needed.

We test our models on approximately 6,000 observations in the sampled
test data set and provided performance of each of those in Section IV
(d) and Section V. In the concluding sections, we make recommendations
on the best models, their uses, and their limitations..
...
weight the observations, which will will explore in the next section.
...
original model (the log transformed model developed in section III (e)).
...
the Q-Q plot for Kc.linear model as shown in Section III (c)),
indicating that the errors may not be exactly fully normally
distributed.
...
# I am planning to build a NN model
# There are 70 zipcode dummy variables.
# Looking to reduce that number.
# One way is to average the house price for each zipcode.
# Bin them into 3 categories, below, average, and above.
# This will reduce 70 vars down to 3.
```
...
# Out of Sample test for NN Model 1
...
**Please refer to the previous sections for model validation.**
...
their use (please see section VI for more information).

## Bibliography

1.  Zach, October 28, 2020, *How to Perform Logistic Regression in R*,
    Statology, April 25, 2023,
    <https://www.statology.org/logistic-regression-in-r/>.

2.  Gogtas, H. (2022, November 28). Neural Networks [Presentation].

3.  Getting Real about Real Estate: A Machine Learning Categorization
    Model, A. (2022). Getting Real about Real Estate: A Machine Learning
    Categorization Model [Bachelor of Science in Engineering, Princeton
    University].

4.  "How to Identify Unusual Observations on Your Regression Model with
    R? \| by Michaelino Mervisiano \| Towards Data Science." n.d.
    Accessed May 1, 2023.
    <https://towardsdatascience.com/how-to-detect-unusual-observations-on-your-regression-model-with-r-de0eaa38bc5b>.

5.  "Understanding QQ Plots \| University of Virginia Library Research
    Data Services + Sciences." n.d. Accessed May 1, 2023.
    <https://data.library.virginia.edu/understanding-q-q-plots/>.

6.  Varshney, Paras. 2020. "Q-Q Plots Explained." Medium. October
    17, 2020.
    <https://towardsdatascience.com/q-q-plots-explained-5aa8495426c0>. 

7.  Zach. 2019. "A Guide to Multicollinearity & VIF in Regression."
    Statology (blog). March 10, 2019.
    <https://www.statology.org/multicollinearity-regression/>.

## Appendix

Box plots and Histograms for each of the dependent variables vs
...
All Other plots and charts are included in their respective sections
